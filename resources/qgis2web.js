...
map.getView().fit([-11529197.749559, 2295705.700011, -11389576.584583, 2398926.207772], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mapa de Establecimientos de Salud Privados - Prospectiva Turismo Médico,  Jalisco 2025 | Mauricio Uro - Consultor</h2>';
        return titleElement;
    })(),
